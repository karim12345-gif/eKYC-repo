...
// processVerification -> simulate async verfication like a real review process
...
const processVerification = async (
  ...
  simulateVerifcationProcess(userId);

  return { status: "PROCESSING_STARTED", estimatedTime };
};

// simulate the actaul verification process
const simulateVerifcationProcess = async (userId: string): Promise<void> => {
